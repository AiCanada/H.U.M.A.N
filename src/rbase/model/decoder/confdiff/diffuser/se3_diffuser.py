...
class SE3Diffuser:
    ...
    def forward_marginal(
        ...
        if not self._diffuse_trans:
            ...
            trans_t, trans_score = self._r3_diffuser.forward_marginal(
                trans_0, t, num_frames=num_frames, correlated_noise=correlated_noise
            )
    ...
    def calc_rot_score(self, rots_t, rots_0, t, use_cached_score=False):
        ...
        return self._so3_diffuser.torch_score(
            rotvec_0t, t, use_cached_score=use_cached_score
        )
    ...
    def sample_ref(
        ...
        rot_ref = self._so3_diffuser.sample_ref(
            batch_size=n_samples // num_frames, seq_len=seq_len, num_frames=num_frames
        )
