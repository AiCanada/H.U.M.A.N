...
"""Cache implementation modifed from https://github.com/huggingface/transformers/blob/main/src/transformers/cache_utils.py"""
...
class OffloadedCache(DynamicCache):
    ...
    def total_cache_size(self) -> int:
        total_bytes = 0
        for key_tensor, value_tensor in zip(self.key_cache, self.value_cache):
