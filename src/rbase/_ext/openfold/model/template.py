...
from rbase._ext.openfold.model.primitives import LayerNorm, Attention
from rbase._ext.openfold.model.dropout import (
    DropoutRowwise,
    DropoutColumnwise,
)
...
from rbase._ext.openfold.utils.checkpointing import checkpoint_blocks
from rbase._ext.openfold.utils.chunk_utils import (
    chunk_layer,
    ChunkSizeTuner,
)
...
def embed_templates_average(
    ...
    for i in range(0, n_templ, templ_group_size):
        def slice_template_tensor(t):
            ...
            # tuple(), not the bare list: torch treats a list index as a tensor
            # index from 2.9, which silently changes the result.
            return t[tuple(s)]
