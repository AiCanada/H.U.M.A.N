...
def _torch_checkpoint(fn, *args, **kwargs):
    # Torch's implicit default is use_reentrant=True. Passing it explicitly
    # silences the PyTorch 2.9 warning without changing the activation-checkpoint
    # graph (do not switch to False here — that would change training).
