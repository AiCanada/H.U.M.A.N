...
from .primitives import AdaLN, Linear, LinearNoBias
...
class ConditionedTransitionBlock(nn.Module):
    ...
    def __init__(self, input_dim: int, n: int = 2):
        """
        Args:
            input_dim:
                Channels of the input tensor
        ...
        self.output_gating_linear.bias = nn.Parameter(
            torch.ones(input_dim) * -2.0
