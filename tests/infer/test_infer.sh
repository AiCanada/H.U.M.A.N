...
WANDB_PROJ=RBase_test # dump to this test tracking project
USER=test_user
...
CKPT_PATH=/mnt/hdfs/gdd/projects/rbase/users/yuning/20250806_confrover1_release/model_weights/confrover_base/confrover_base.pt
